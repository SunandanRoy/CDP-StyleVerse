...
const BRANDS = [
  { id: "speedstyle", name: "SpeedStyle", posture: "Automate-heavy, Self-Directed",
    ...
    seeded_return_rate_target: 28, seeded_return_rate_tier: "A (case)", price_band: [499, 2999] },
  { id: "urbanedge", name: "UrbanEdge", posture: "Balanced, Self-Directed",
    ...
    seeded_return_rate_target: 21, seeded_return_rate_tier: "C (team interpretation)", price_band: [1299, 4999] },
  { id: "maisonluxe", name: "Maison Luxe", posture: "Amplify-dominant, Advisor-Mediated",
    ...
    seeded_return_rate_target: 9, seeded_return_rate_tier: "A (case)", price_band: [12000, 48000] },
  { id: "ecoweave", name: "EcoWeave", posture: "Augment-led",
    ...
    seeded_return_rate_target: 16, seeded_return_rate_tier: "C (team interpretation)", price_band: [1999, 6999] },
  { id: "threadbasics", name: "ThreadBasics", posture: "Rules-engine automate",
    ...
    seeded_return_rate_target: 19, seeded_return_rate_tier: "C (team interpretation)", price_band: [299, 1799] }
];
