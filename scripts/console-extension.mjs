...
const modelRegistry = [
  { id: 'model_confidence', name: 'Confidence Score Model', version: 'v2.3', status: 'Production', owner: 'Customer Analytics', last_validated: addDays(DEMO_TODAY, -18), override_rate: null, notes: 'A deterministic, fully explainable formula rather than a trained model — validated through automated tests and an ongoing calibration chart comparing predicted scores against actual outcomes.' },
  { id: 'model_archetype', name: 'Archetype Assignment (nearest-centroid)', version: 'v1.4-prototype', status: 'Prototype', owner: 'Customer Analytics', last_validated: addDays(DEMO_TODAY, -18), override_rate: null, notes: 'Assigns each customer to the nearest body-profile archetype using height, bust, waist, hip and usual size; a production rollout would move to a clustering model trained on a larger dataset.' },
  { id: 'model_interception', name: 'Return Interception Decision Engine', version: 'v1.1', status: 'Production', owner: 'Customer Analytics', last_validated: addDays(DEMO_TODAY, -30), override_rate: avgOverrideRateFor('Auto-intercept return with exchange offer'), notes: 'A rules engine layered on top of the confidence score and live stock levels to decide when to offer an exchange instead of a return.' },
  { id: 'model_case_triage', name: 'Case Auto-Close Classifier', version: 'v1.0', status: 'Production', owner: 'Digital Customer Support', last_validated: addDays(DEMO_TODAY, -25), override_rate: avgOverrideRateFor('Auto-close case as resolved'), notes: 'Flags an automation-bias watch on SpeedStyle — see Override Wins.' },
  { id: 'model_voice_rubric', name: 'Brand Voice Certification Rubric', version: 'v2.0', status: 'Production', owner: 'Customer Journey & Experience Design', last_validated: addDays(DEMO_TODAY, -5), override_rate: null, notes: 'A deterministic rubric checking tone, banned phrasing, emoji policy, apology count and brand-specific rules — it also guards every live AI-generated response before it can go out.' },
  { id: 'model_grievance', name: 'Grievance Radar Risk Score', version: 'v1.0-prototype', status: 'Prototype', owner: 'Digital Customer Support', last_validated: addDays(DEMO_TODAY, -12), override_rate: null, notes: 'A rule-based risk score on delivery delays, with sensitivity tied to the AI Involvement Dial\'s proactivity setting.' },
  { id: 'model_signal', name: 'Marketplace Signal Miner', version: 'v1.2', status: 'Production', owner: 'Marketplace Operations', last_validated: addDays(DEMO_TODAY, -40), override_rate: null, notes: 'Surfaces SKU-level aggregate return patterns only — individual marketplace buyer identity is never exposed.' }
]
